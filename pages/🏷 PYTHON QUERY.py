...
with st.expander("select count **State** by frequency and print in dataframe and show simple bar graph with grids and legend"):
...
# Query 11
with st.expander("Select count **BusinessType** by frequency"):
...
with st.expander("select count **BusinessType**  by frequency and print in dataframe and show simple bar graph with grids and legend"):
...
# Query 13
with st.expander("select minimal **Investment** and minimal **Rating** where **State** is Mwanza and date is range from 2-jan-21 to 16-jan-21"):
...
# Query 1
with st.expander("select count **Location** where **Location** ='Dodoma'"):
 count_location = df[df['State'] == "Dodoma"]['Location'].count()
 st.info(f"## {count_location}")

# Query 2
with st.expander(" select count  **Location** and **Region** where **Location** ='Dodoma' and **Region**='East'"):
 count_location_region = df[(df['State'] == "Dodoma") & (df['Region'] == "East")]['Location'].count()
 st.info(f"## {count_location_region:,.3f}")

# Query 3
with st.expander("select count  **Location** and **Region** where **Location** ='Dodoma' and **Region**='East' and **Investment** is greater than 300000"):
...
# Query 4
with st.expander("select average mean of **investment** where **State**='Dodoma' and **Location** is not  'Urban'"):
...
# Query 7
with st.expander("select Median of **Investment**  and **Rating** where **State** is Mwanza, **Location** is Urban and **Investment** is greater than 400,000"):
...
# Query 8
with st.expander("select median of **Investment**  and **Rating** where **State** is Mwanza **Location** is Urban and **Investment** is greater than 400,000 and **Expiry** is a date range from 2-jan-21 to 16-jan-21"):
...
# Query 3
with st.expander('Select all from **Location** and **Region** where **Location** ="Dodoma" and **Region**="East" and **Investment** is greater than 300,000'):
...
with st.expander("select **State**, **Region**, **Location** and  **BusinessType**  where **Region** is 'East'and **investment** greater than 2219900 and **BusinessType** is not  'Other' and **Construction** is Frame or FireResist and **State** is Dar es Salaam or Dodoma"):
